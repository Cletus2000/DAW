...
<?php include 'nav_bar1.php'; ?>
    ...
    <main>
        <h1>Error, inicia sesión para ver los detalles de la foto</h1>
        <section>
            <h2>Inicia sesión para ver los detalles de la foto</h2>
            
            <a class="boton" href="form.html">Registrarse</a>
